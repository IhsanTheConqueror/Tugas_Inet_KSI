...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=342548790ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ukm&table=tb_admin">`ukm`.`tb_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ukm&table=tb_kegiatan">`ukm`.`tb_kegiatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ukm&table=tb_altif">`ukm`.`tb_altif`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ukm&table=tb_pendaftaran">`ukm`.`tb_pendaftaran`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6b65303d5149244d4c626e3c4d646f60">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ukm" targettable="tb_altif">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_altif`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_altif">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_altif`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_pendaftaran">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_pendaftaran`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_altif">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="ukm" targettable="tb_kegiatan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `ukm`.`tb_kegiatan` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nama_kegiatan` VARCHAR(100) NOT NULL ,  `tgl` DATE NOT NULL ,  `ket` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ukm" targettable="tb_kegiatan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `tb_kegiatan` DROP `ket`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_kegiatan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_kegiatan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_kegiatan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_kegiatan`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ukm" targettable="tb_admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_admin`</span>
                        </div>
